	...
	return (
		...
		>
			{/* <img
				...
				alt="logo_pic"
			/> */}
            <div className="text-2xl font-bold dark:text-white">Imagi<span className="text-blue-500">net</span></div>
			...
			<div
				...
				}  max-sm:fixed top-0 bottom-0 right-0 max-sm:min-h-screen max-sm:h-full flex max-sm:flex-col max-sm:bg-primary max-sm:text-white max-sm:pt-20 sm:items-center gap-5 transition-all`}
			>
				<img
			...
			<div className="flex items-center gap-2 sm:gap-4">
				...
				>
					Connect{" "}
					<img src={assets.arrow_icon} width={14} alt="connect_pic" />
				</a>
			</div>
		</motion.div>
	);
